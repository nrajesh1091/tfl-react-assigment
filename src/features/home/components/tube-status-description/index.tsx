...
const TflStatusDashboard = ({ openModalPopUp }) => {
    // Group lines
                        ...
                        <div className="flex-col">
                            {groupedLines?.[group]?.map((line, index) => (<Fragment key={index} >
                                <div key={line.id} className="flex grow   md:grow-0 p-1 mb-1 rounded-lg" >
                                    ...
                                    {line.reason && <><a href="#" aria-description="Please click to know further details" onClick={() => openModalPopUp(line)}
                                        className="text-blue-600 visited:text-purple-600>">ℹ️</a>
